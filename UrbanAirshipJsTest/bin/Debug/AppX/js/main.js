...
(function () {
    ...
    app.onactivated = function (args) {
        ...
        configBtn.onclick = function (event) {
            ...
            var res = RuntimeComponentTest.Class1.setUAConfig("WEUYEjWQT0-NSXuBWFfoyw", "EfLkiERhSK22vPZOKILYYw", false);
            console.log(res);
        ...
        initBtn.onclick = function (event) {
            console.log("init UA");
            var res = RuntimeComponentTest.Class1.initUA("../airshipconfig.xml");
            console.log(res);
        ...
        notificationsBtn.onclick = function (event) {
            ...
            var res = RuntimeComponentTest.Class1.setUserNotificationsEnabled(true);
            console.log(res);
        ...
        var setApid = function () {
            ...
            var res = RuntimeComponentTest.Class1.setApid("42");
            console.log(res);
